...
class EventsManager {
          ...
          if (data.msg=="OK") {
            ...
            if (document.getElementById('allDay').checked) {
              $('.calendario').fullCalendar('renderEvent', {
                id: data.id_evento //Inlcuido por jeffrey cortés
                ,title: $('#titulo').val()
    ...
    eliminarEvento(event, jsEvent){
      var form_data = new FormData()
      form_data.append('id_evento', event.id)
      $.ajax({
    ...
    actualizarEvento(evento) {
        ...
        form_data.append('fec_ini', start_date)
        form_data.append('fec_fin', end_date)
        form_data.append('hora_ini', start_hour)
